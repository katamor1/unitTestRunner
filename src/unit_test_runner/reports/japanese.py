...
_LABELS = {
    ...
    "runner_case_incomplete": "runnerケース未完了",
    "runner_case_not_reached": "runnerケース未到達",
    "runner_case_not_reached_after_failure": "runnerケース未到達",
    "runner_case_timeout": "runnerケースタイムアウト",
