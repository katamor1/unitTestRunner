...
def build_parser() -> argparse.ArgumentParser:
    ...
    analyze.add_argument("--previous-test-spec")
    ...
    harness_spec = harness.add_mutually_exclusive_group(required=True)
    harness_spec.add_argument("--test-spec")
    harness_spec.add_argument("--test-case-design", help="Deprecated v0.1 compatibility alias; migrated in memory only.")
    ...
    run_mode.add_argument("--dry-run", action="store_true", help="Deprecated alias for --plan.")
    ...
    get_spec = subcommands.add_parser("get-test-spec", help="Read and validate the canonical test specification.")
    get_spec.add_argument("--workspace", required=True)

    update_spec = subcommands.add_parser("update-test-spec", help="Apply a revision-checked patch to the canonical test specification.")
    update_spec.add_argument("--workspace", required=True)
    ...
    previous_spec.add_argument("--previous-test-case-design", help="Deprecated v0.1 compatibility alias.")
    reconcile.add_argument("--previous-coverage-design", required=True)
    current_spec = reconcile.add_mutually_exclusive_group(required=True)
    current_spec.add_argument("--current-test-spec")
    current_spec.add_argument("--current-test-case-design", help="Deprecated v0.1 compatibility alias.")
    ...
    suite_mode = suite_run.add_mutually_exclusive_group()
    suite_mode.add_argument("--run", action="store_true")
    suite_mode.add_argument("--plan", action="store_true")
    suite_mode.add_argument("--dry-run", action="store_true", help="Deprecated alias for --plan.")
