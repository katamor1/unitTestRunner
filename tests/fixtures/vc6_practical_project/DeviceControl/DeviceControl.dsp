...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "DEVICE_CONTROL_FEATURE=1" /I "..\include" /FI"config_alias.h" /Yu"stdafx.h" /MDd /Fo"Debug/" /Fd"Debug/" /FD /GZ /c

!ELSEIF "$(CFG)" == "DeviceControl - Win32 Release"

# PROP BASE Use_MFC 0
# ADD BASE CPP /nologo /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /ML /YX /FD /c
# ADD CPP /nologo /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "DEVICE_CONTROL_FEATURE=1" /I "..\include" /FI"config_alias.h" /Yu"stdafx.h" /MD /Fo"Release/" /Fd"Release/" /FD /c

!ENDIF

# Begin Target
# Name "DeviceControl - Win32 Debug"
# Name "DeviceControl - Win32 Release"
